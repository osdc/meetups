...
| Date       | Meetup Topic 	          | Details                                       | Speaker(s) | Talk Slides/Notes                                            |
| ---------- | -------------------------- | --------------------------------------------- | ---------- | -------------------------------------------------------------|
| 2023-01-27 | GSoC | Intro & discussion about these student programs and how to apply to them. | Core Team | [GSoC Student Guide](https://google.github.io/gsocguides/student/)
| 2022-11-22 | May I Own Your Phone? | Demonstrated how malware APK files can be used to access the camera, call logs and other sensitive information in a smartphone. | [@0xquark](https://github.com/0xquark), [madhavmehndiratta](https://github.com/madhavmehndiratta) | [Slides](https://drive.google.com/file/d/1s60ozqSfsSIwxX27u5T4GOZJeLyXp_XC/view)
| 2022-10-18 | Texting: Editors and IDE's | Discussed and demonstrated the differences between different Text Editors and IDE's like VS Code, Sublime Text, and vim/neovim. | [@DepressedSage](https://github.com/DepressedSage/) | Free Talk
...
| 2022-07-29 | The Hitchhiker’s Guide to the Cooler Parts of the Internet | Talk and demonstration of OSINT, Google dorking, Shodan, the Internet archive, Guestbooks and the design of the old web, Modern Web-Bloat and the gopher protocol. | [@exitflynn](https://github.com/exitflynn) | [Slides](https://drive.google.com/file/d/1qjuD6sPeYsTk-1NivfrbFF01TxPtAZMC/view?usp=sharing) \| [Links](https://drive.google.com/file/d/1tENBDOViBlKlIXuvVj0d78uKeg8HtdrI/view?usp=sharing) |
