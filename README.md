...
| ---------- | -------------------------- | --------------------------------------------- | ---------- | -------------------------------------------------------------|
| 2022-10-12 | Introductory Workshop On GitHub And Getting Started With Hacktoberfest | Introduced newcomers to Hacktoberfest, git and GitHub. Had people install git-bash and make a Pull Request. Announced OSDContenst, a content-writing contest that aims to familiarize people with contributing to Open Source. | [@exitflynn](https://github.com/exitflynn) | [Slides](https://drive.google.com/file/d/1pT04MiOmn2AP1OQ6ePhz5Fo9kwqQqAU5/view)
